...
const HeroHome: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen">
      <div className="absolute rounded-full bg-pink-400/40 w-96 h-96 top-20 -right-40 blur-2xl"></div>
      <div className="absolute rounded-full bg-blue-400/40 w-96 h-96 bottom-14 -left-40 blur-2xl"></div>
      ...
      <Link href="/app">
        <a className="px-4 py-2 mt-4 text-lg text-white border-2 rounded-full border-slate-400 hover:bg-gradient-to-r from-pink-400 to-blue-400">
          Join Now
        </a>
      </Link>
    </div>
